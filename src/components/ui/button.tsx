...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:bg-disabled hover:scale-95 transition-all duration-300',
  {
    variants: {
      variant: {
        default: 'bg-primary text-zinc-50',
        ...
        link: 'text-link underline-offset-4 hover:underline hover:scale-100',
      },
      size: {
